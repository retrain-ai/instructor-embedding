...
This is a fork for the Instructor model because the original repository isn't kept up anymore.  I've also made some improvements to their source code:
...
### Future development
Follow these [steps](https://retrain.atlassian.net/wiki/spaces/DE/pages/1118732289/Publish+Consume+Python+Package+to+from+our+Artifactory#Create-and-publish-the-package) to publish a new version
